...
class NavBar1 extends Component {
  ...
  handleChange = (e)=>{
    let s1 = {...this.state}
    s1.searchData=e.currentTarget.value

    this.props.onFilter(s1.searchData)
  }
    ...
    return (<div>
      <div className="row bg-dark">
        ...
        <div className="col-lg-3 mt-2">
          ...
          <Nav style={{ marginLeft: "400px", color: "white" }}>
            <NavDropdown
              style={{ color: "white" }}
            ...
            >
              <NavDropdown.Item href="/home/NCR">NCR</NavDropdown.Item>
              <NavDropdown.Item href="/home/Banglore">Banglore</NavDropdown.Item>
              <NavDropdown.Item href="/home/Ahmedabad">Ahmedabad</NavDropdown.Item>
              <NavDropdown.Item href="/home/Chennai">Chennai</NavDropdown.Item>
              <NavDropdown.Item href="/home/Mumbai">Mumbai</NavDropdown.Item>
              <NavDropdown.Item href="/home/Hyderabad">Hyderabad</NavDropdown.Item>
            </NavDropdown>
          </Nav>

        </div>
        <div className="col-lg-3 mt-2">
          <h5 className="text-light mt-1" style={{ marginLeft: "220px" }}>English</h5>
        </div>
        <div className="col-lg-2 mt-2">
          <button className="btn btn-outline-light btn-sm" style={{ width: "100px" }} variant="outline-light">Sign In</button>
        </div>
      </div>
      <div className="row bg-dark text-center text-light">
        <div className="col-lg-3">Movies</div>
        <div className="col-lg-2">Events</div>
        <div className="col-lg-2">Plays</div>
        <div className="col-lg-3">Activities</div>
        <div className="col-lg-2">Fanhood</div>
      </div>
    </div>)
  }
